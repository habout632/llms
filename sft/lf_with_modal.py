...
CONFIG_URL = f"https://huggingface.co/datasets/habout632/medicine_test/resolve/main/medbench_20241204.jsonl"
...
image = (
    ...
    .apt_install("wget")
    .apt_install("git")
    .run_commands([f"git clone --depth 1 https://github.com/hiyouga/LLaMA-Factory.git"])
...
def run():
    ...
    result = subprocess.run(["llamafactory-cli", "train", "/root/sft.yaml"], capture_output=True, text=True)
    print(result.stdout)
